...
class MarkdownRAG:
    ...
    def ingest(self, md_file_path: str):
        ...
        markdown_content = load_markdown_file(md_file_path)

        # Split the markdown content into chunks and wrap them into Document objects
        docs = [Document(page_content=markdown_content)]
        
        # Split into smaller chunks using the text_splitter
        chunks = self.text_splitter.split_documents(docs)
        
        # Optionally filter complex metadata if required
